 ...
 * @abstract
 * @property {Request} req - Express request object
 * @property {Response} res - Express response object
 * @method {executeImplementation} - Abstract method to be implemented by child classes
 * @method {execute} - Executes the controller
...
export abstract class Controller {
  ...
  protected abstract executeImplementation(...arguments_: unknown[]): Promise<Response>
  ...
  public paymentRequired(message?: string) {
    return Controller.jsonResponse(this.res, 402, message ?? 'Payment required')
  }
  ...
  public tooMany(message?: string) {
    return Controller.jsonResponse(this.res, 429, message ?? 'Too many requests')
  }
